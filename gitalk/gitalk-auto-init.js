...
// 配置信息
const config = {
  username: 'fightinggg', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: "fightinggg.github.io", // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
  token: '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', // 前面申请的 personal access token
