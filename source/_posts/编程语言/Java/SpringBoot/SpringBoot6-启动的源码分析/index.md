---
date: 2020-04-28 21:38:55
updated: 2020-04-28 21:38:55
---
...
```
### 第17行
准备环境, 获取环境，这里的getOrCreateEnvironment分三种，点进去就知道了, 获取后配置环境,之后回调listeners的环境准备完成函数`listeners.environmentPrepared(environment);`
```java
...
### 第31行
```java
回调所有的runner，里面包含了APplicationRunner和CommandLineRunner， 优先调用前者
