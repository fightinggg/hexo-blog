...
```mermaid
graph TD
  I1("PRODUCTION -> · SUM<br/>PRODUCTION -> · MUL<br/>SUM -> · PRODUCTION + MUL<br/>MUL -> · MUL * number<br/>MUL -> · number")
  I2("MUL -> number ·")
  I3("PRODUCTION -> SUM · ")
  I4("PRODUCTION -> MUL · <br/>MUL -> MUL · * number")
  I5("SUM -> PRODUCTION · + MUL")
  I6("MUL -> MUL * · number")
  I7("MUL -> MUL * number · ")
  I8("SUM -> PRODUCTION + · MUL<br/>MUL -> · MUL * number<br/>MUL -> · number")
  I9("SUM -> PRODUCTION + MUL ·<br/>MUL -> MUL · * number")
  I10("MUL -> number ·")
  I1 -->|number| I2
  I1 -->|SUM| I3
  I1 -->|MUL| I4
